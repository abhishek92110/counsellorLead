...
const DataState = (props) => {
    ...
    const getAllCampaign = async () => {
      ...
      updateProgress(30);
      updateBarStatus(true);
        let allCampaign = await fetch("http://localhost:8000/getfacebookCampaignData", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
          }
      ...
      const getTrainer = async () => {
        ...
        updateProgress(30);
        updateBarStatus(true);
          let allTrainer = await fetch("http://localhost:8000/getTrainers", {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
            }
      ...
      const getLatestData = async () => {
        ...
        try {
            let totalLatestData = await fetch('http://localhost:8000/getLatestFacebookAdData', {
                method: 'GET',
            });
