...
getAllCounsellor()
  ...
  let tempNoResponse = latestData

  tempNoResponse[dataIndex].counsellorNo = allCounsellor[counsellorIndex].counselorNo;
  tempNoResponse[dataIndex].counsellorName = allCounsellor[counsellorIndex].Name

  console.log("tempNoResponse =",tempNoResponse)

  setLatestData(tempNoResponse)
...
return (`${year}-${month}-${day}`)
 ...
 return(
    <div>
            <h3>No Response - {latestData.length}</h3>
