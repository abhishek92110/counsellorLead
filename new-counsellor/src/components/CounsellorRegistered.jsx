...
const CounsellorRegistered = () => {
  ...
  const setAssignedCounsellor = (index)=>
    ...
    let tempCounsellorRegistered = latestData

    tempCounsellorRegistered[dataIndex].counsellorNo = allCounsellor[counsellorIndex].counselorNo;
    tempCounsellorRegistered[dataIndex].counsellorName = allCounsellor[counsellorIndex].Name

    setLatestData(tempCounsellorRegistered)
...
const getLead = async()=>{
 ...
 return(
    <div>
            <h3>Registered - {latestData.length}</h3>
...
export default CounsellorRegistered;
