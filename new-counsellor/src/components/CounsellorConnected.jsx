...
const addDemo = (element, index, value) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      Swal.fire({
        ...
        text: `Demo successfully rescheduled with trainer ID: ${trainerName}`
      });
    }
  });
};
  ...
  const setAssignedCounsellor = (index)=>
    ...
    let tempCounsellorConnected = latestData

    tempCounsellorConnected[dataIndex].counsellorNo = allCounsellor[counsellorIndex].counselorNo;
    tempCounsellorConnected[dataIndex].counsellorName = allCounsellor[counsellorIndex].Name

    setLatestData(tempCounsellorConnected)
