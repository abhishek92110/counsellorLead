...
const CounsellorNotJoined = () => {
  ...
  const setAssignedCounsellor = (index)=>
    ...
    let tempCounsellorNotJoined = latestData

    tempCounsellorNotJoined[dataIndex].counsellorNo = allCounsellor[counsellorIndex].counselorNo;
    tempCounsellorNotJoined[dataIndex].counsellorName = allCounsellor[counsellorIndex].Name

    setLatestData(tempCounsellorNotJoined)
...
export default CounsellorNotJoined;
