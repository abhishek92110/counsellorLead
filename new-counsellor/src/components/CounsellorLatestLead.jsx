...
const CounsellorLatestLead = () => {
  ...
  const setAssignedCounsellor = (index)=>
    ...
    let tempCounsellorLatestLead = latestData

    tempCounsellorLatestLead[dataIndex].counsellorNo = allCounsellor[counsellorIndex].counselorNo;
    tempCounsellorLatestLead[dataIndex].counsellorName = allCounsellor[counsellorIndex].Name

    setLatestData(tempCounsellorLatestLead)
...
export default CounsellorLatestLead;
