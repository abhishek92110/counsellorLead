...
getAllCounsellor()
  ...
  let tempNotInterested = latestData

  tempNotInterested[dataIndex].counsellorNo = allCounsellor[counsellorIndex].counselorNo;
  tempNotInterested[dataIndex].counsellorName = allCounsellor[counsellorIndex].Name

  console.log("tempNotInterested =",tempNotInterested)

  setLatestData(tempNotInterested)
