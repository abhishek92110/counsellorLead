...
getAllCounsellor()
  ...
  let tempRegistered = latestData

  tempRegistered[dataIndex].counsellorNo = allCounsellor[counsellorIndex].counselorNo;
  tempRegistered[dataIndex].counsellorName = allCounsellor[counsellorIndex].Name

  console.log("tempRegistered =",tempRegistered)

  setLatestData(tempRegistered)
