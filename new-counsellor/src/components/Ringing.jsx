...
getAllCounsellor()
  ...
  let tempRinging = latestData

  tempRinging[dataIndex].counsellorNo = allCounsellor[counsellorIndex].counselorNo;
  tempRinging[dataIndex].counsellorName = allCounsellor[counsellorIndex].Name

  console.log("tempRinging =",tempRinging)

  setLatestData(tempRinging)
...
return (`${year}-${month}-${day}`)
 ...
 return(
    <div>
            <h3>Ringing - {latestData.length}</h3>
