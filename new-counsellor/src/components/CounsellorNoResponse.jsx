...
const addDemo = (element, index, value) => {
  ...
  const setAssignedCounsellor = (index)=>
    ...
    let tempCounsellorNoResponse = latestData

    tempCounsellorNoResponse[dataIndex].counsellorNo = allCounsellor[counsellorIndex].counselorNo;
    tempCounsellorNoResponse[dataIndex].counsellorName = allCounsellor[counsellorIndex].Name

    setLatestData(tempCounsellorNoResponse)
...
export default CounsellorNoResponse;
